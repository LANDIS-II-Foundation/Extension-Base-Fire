...
Source: {#LandisBuildDir}\disturbanceextensions\base fire\build\release\Landis.Extension.BaseFire.dll; DestDir: {app}\bin; Flags: replacesameversion

; Base Fire
Source: docs\LANDIS-II Base Fire v2.1 User Guide.pdf; DestDir: {app}\docs
Source: examples\*; DestDir: {app}\examples

#define BaseFire "Base Fire 2.1.1.txt"
